...
def _draw_linecollection( data, obj ):
    ...
    import itertools
    for path,color,style,width in zip(obj.get_paths(),itertools.cycle(obj.get_edgecolors()),
                                      itertools.cycle(obj.get_linestyles()),itertools.cycle(obj.get_linewidths())):
